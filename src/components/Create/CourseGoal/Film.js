...
const Film = () => {
    return (
        <div>
             <div>
                <h2 className='text-start'>Film & edit</h2>
                <hr className='' />
                <div className=" bg-light m-4 gx-2 d-flex align-items-center">
                    <div className="">
                        <h5 className='mt-3 fw-bold'>You’re ready to share your knowledge.</h5>
                        <p className=''>This is your moment! If you’ve structured your course and used our guides, you're well prepared for the actual shoot. Pace yourself, take time to make it just right, and fine-tune when you edit.</p>
                    </div>
                    <div className="mb-3">
                        <div class="shadow-lg" style={{ width: '18rem' }}>
                            ...
                            <div class="card-body">
                                ...
                                <p className='mt-3 w-75 ms-4 fw-bold ps-5 border border-dark'>Join the community</p>
